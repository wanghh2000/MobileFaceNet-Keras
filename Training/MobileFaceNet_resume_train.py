...
'''Last updated on 12/10/2019 09:33''' 
...
model = mobile_face_net_train(OLD_NUM_LABELS) 
...
if FC_LAYER_CHANGE == True or OLD_NUM_LABELS != NUM_LABELS: 
    # Re-define the model
...
elif OLD_NUM_LABELS == NUM_LABELS and FC_LAYER_CHANGE == False: 
